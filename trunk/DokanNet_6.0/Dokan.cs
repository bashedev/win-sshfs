...
namespace DokanNet
{
    public static class Dokan
    {
        ...
        public static void Mount(this IDokanOperations operations, DokanOptions options)
        {
            ...
            {
                case DOKAN_ERROR:
                    throw new DokanExeption(status, "General Dokan error");
                case DOKAN_DRIVE_LETTER_ERROR:
                    throw new DokanExeption(status, "Bad drive letter");
                case DOKAN_DRIVER_INSTALL_ERROR:
                    throw new DokanExeption(status, "Can't install driver");
                case DOKAN_MOUNT_ERROR:
                    throw new DokanExeption(status, "Can't assign drive letter");
                case DOKAN_START_ERROR:
                    throw new DokanExeption(status, "Somethings wrong with Dokan driver");
            }
        }
        ...
        {
            get { return NativeMethods.DokanVersion(); }
        }

        public static uint DriverVersion
        {
            get { return NativeMethods.DokanDriverVersion(); }
        }
    }
}