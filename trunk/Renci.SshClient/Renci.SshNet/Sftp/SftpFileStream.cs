...
namespace Renci.SshNet.Sftp
{
    ...
    public class SftpFileStream : Stream
    {
        ...
        public SftpFileStream(SftpSession session, string path, FileMode mode, FileAccess access, int bufferSize)
        ...
        internal SftpFileStream(SftpSession session, string path, FileMode mode, FileAccess access, int bufferSize, bool useAsync)
        {
            ...
            this._handle = this._session.OpenFile(this._path, flags);
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            lock (this._lock)
            {
                if (this._handle != null)
                {
                    ...
                    if (this._ownsHandle)
                    {
                        this._session.CloseHandle(this._handle);
                    }
                    this._handle = null;
                }
            }
        ...
        private void FlushWriteBuffer()
        {
            if (this._bufferPosn > 0)
            {
                ...
                this._session.Write(this._handle, (ulong)(this.Position - this._bufferPosn), data);
