...
namespace Renci.SshNet.Sftp
{
    public class SftpSession : IDisposable
    {
        ...
        /// <param name="handle">The handle.</param>
        /// <returns></returns>
        public IDictionary<string, SftpFileAttributes> RequestReadDir(byte[] handle)
        {
        ...
        /// <param name="nullOnError">if set to <c>true</c> returns null instead of throwing an exception.</param>
        /// <returns></returns>
        public IDictionary<string, SftpFileAttributes> RequestRealPath(string path, bool nullOnError = false)
        {
            IDictionary<string, SftpFileAttributes> result = null;
